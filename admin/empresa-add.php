...
<div class="container">
	...
	<?php require "template/nav_testimonios.php"; ?>
		<div class="grid col-9">
			...
			<div class="row">
				<h2>Empresa Sólo Texto</h2>
				<hr>
				<form action="empresa-add_2-ok.php" method="post" enctype="multipart/form-data" class="add-empresa" id="add-empresa2">
					<div class="row-empresa">
						<label for="">Nombre de la empresa</label>
						<input type="text" placehodler="" id="nombre" name="nombre_d">
					</div><br>
					<input type="submit" value="Agregar esta empresa">
				</form>
			</div>
