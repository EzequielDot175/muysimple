    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
       ...
       <div class="row SacarWeb Col_1Mobile Text-Donaciones clearfix">
        ...
        </div><!-- /swiper-slide PlacaDonaciones -->
...
<section class="QuererAyudar clearfix" id="SeccionComoAyudar">
    ...
    <h1>¿Cómo Ayudar?</h1>
        ...
        <article class="dataComoAyudar Col_1Mobile">
                ...
                <p class="MailComoAyudar"><span class="FlechaNumero">›</span>(+54) 11 6872 2073  </p>
	...
	<div class="row clearfix">
    	<h1>Quienes Integramos La Fundación</h1>
            ...
            <a href="#"> 
            	...
            	<figure><div class="content-contacto"><div class="SobreContacto"></div><p>sol.quevedo@muysimple.com</p></div> <img src="resources/images/juan.jpg" width="241" height="195" title="juan Quevedo"/></figure>
            		<figcaption>Juan Quevedo</figcaption>
                    	<p>Presidente</p>
             </a>
            </article>
    		<article class="integrantes">
              <a href="#">
            	<figure><div class="content-contacto"><div class="SobreContacto"></div><p>sol.quevedo@muysimple.com</p></div> <img src="resources/images/juan.jpg" width="241" height="195" title="juan Quevedo"/></figure>
                	<figcaption>Sol Quevedo</figcaption>
                    	<p>Vicepresidente </p>
              </a>
            </article>
            <article class="integrantes">
              <a href="#">
            	<figure><div class="content-contacto"><div class="SobreContacto"></div><p>sol.quevedo@muysimple.com</p></div> <img src="resources/images/noname.jpg" width="241" height="195" title="juan Quevedo"/></figure>
                	<figcaption>Francisco Quevedo</figcaption>
                    	<p>administrador de finanzas </p>
              </a>
            </article>
           
            <article class="integrantes">
                <a href="#">
            	<figure><div class="content-contacto"><div class="SobreContacto"></div><p>sol.quevedo@muysimple.com</p></div><img src="resources/images/noname.jpg" width="241" height="195" title="Osvaldo Silva"/></figure>
            		<figcaption>Ana Quevedo</figcaption>
                    	<p>Coordinación de proyectos / relaciones institucionales</p>
                 </a>       
            </article>
            <article class="integrantes">
            	  <a href="#">
            	<figure><div class="content-contacto"><div class="SobreContacto"></div><p>ursula.carle@muysimple.org</p></div><img src="resources/images/noname.jpg" width="241" height="195" title="Osvaldo Silva"/></figure>
            		<figcaption>Úrsula Carle</figcaption>
                    	<p>Coordinadora de cursos y<br> talleres</p>
                   </a>
            </article>
            <article class="integrantes">
            	  <a href="#">
            	<figure><div class="content-contacto"><div class="SobreContacto"></div><p>sandra.acosta@muysimple.org</p></div><img src="resources/images/noname.jpg" width="241" height="195" title="Osvaldo Silva"/></figure>
            		<figcaption>Sandra Acosta</figcaption>
                    	<p>Prensa/Cel: 155982589</p>
                  </a>
            </article>
    </div>	
</section>
...
<footer class="site-pie clearfix">
    ...
    <p>Av. Santa Fe 5362 Palermo (C.P. C1425BYP)</p>
