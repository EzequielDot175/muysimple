...
function insertCapacitacion(){
    ...
    $sql = "INSERT INTO capacitacion SET titulo='$titulo', detalle='$detalle', imagen='$imagen', sede='$sede', duracion='$duracion', horarios='$horarios', fecha_inicio='$fecha_inicio', profesor='$profesor'";
    $resultado = $db->query($sql);
