...
function traerCapacitacion(){
    ...
    while ($data = $resultado->fetch_object()){
        ...
        <p>".date('d', strtotime($data->fecha_inicio)). ' de '.date('M D', strtotime($data->fecha_inicio))."</p>
...
function insertCapacitacion(){
    ...
    $sql = "INSERT INTO capacitacion SET titulo='$titulo', detalle='$detalle', imagen='$imagen', imagen_2='$imagen_2', sede='$sede', duracion='$duracion', horarios='$horarios', fecha_inicio='$fecha_inicio', profesor='$profesor', video='$video1'";
    $resultado = $db->query($sql);
