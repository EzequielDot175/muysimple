...
require "../../resource/db.php";
	...
	$sql = ("UPDATE capacitacion SET titulo='$titulo', detalle='$detalle', imagen='$imagen', imagen_2='$imagen_2', sede='$sede', duracion='$duracion', horarios='$horarios', fecha_inicio='$fecha_inicio', profesor='$profesor' WHERE id_cap='$id'");
