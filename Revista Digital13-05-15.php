...
<header class="site-header HeaderNovedades">
	<div class="row clearfix">
        ...
        <nav class="site-nav">
        	<ul>
                <li class="LaFundacion">
                <a class="Menu" href="QuienesSomos.php" title="La fundación">La fundación</a>
                <ul>
                ...
                <li ><a class="SubMenu" href="QuienesSomos.php#PerosnasFundacion" title="Quienes integramos la Fundación">Quienes integramos<br>la Fundación</a></li>
                </ul>
                </li>
                ...
                <li><a class="SelectorDistintoHover" href="LaTienda.php" title="La tienda"><span class="SelectorNegroHover">La tienda</span></a></li>
