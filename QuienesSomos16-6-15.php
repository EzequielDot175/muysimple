	...
	<div class="row clearfix">
        ...
        <?php foreach($x->fetch() as $k => $v): ?>
            ...
            <a href="mailto:<?php echo($v["email"]) ?>"> 
            	<figure>
                    <div class="content-contacto"><div class="SobreContacto"></div><p><?php echo($v["email"]) ?></p></div> <img src="upload/<?php echo($v["img"]) ?> " width="241" height="195" title="<?php echo($v["nombre"])?>"/>
                </figure>
