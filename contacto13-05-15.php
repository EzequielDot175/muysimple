    ...
    <form action="functions/send.php" method="post">
     ...
     <span class="icon MarcadorMapaVerdeClaro"></span>
        ...
        Estación Rivadavia correspondiente al Ramal "Retiro-Tigre" del Ferrocarril General Bartolomé Mitre</p>
      	...
      	<div class="dataContacto">
        <h1>Sedes</h1>
    	<p><span>Florencio Varela </span><br>
    	Calle 1132 A N°2560, Ingeniero Allan</p>
         </div>
      ...
      if ($(this).attr('checked')) {
         ...
         <form class="seleccion" name="form1" method="post" action="">
            ...
            <input type="radio" name="option4" id="radio4" class="radio" value="Facebook" style="display:none">
             ...
             <input type="radio" name="option5" id="radio5" class="radio" value="Avisos en via pública" style="display:none">
