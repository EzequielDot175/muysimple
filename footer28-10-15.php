<style type="text/css">
#logosfooter1 { float:right;  margin-top: 4px;     margin-right: 8px;}
#logosfooter1:hover { opacity: 0.8;}
  #logosfooter2 { float:right; 
    margin-top: 4.4px;
        margin-right: 20px; }
        #logosfooter2:hover { opacity: 0.8;}
</style>
...
<footer class="site-pie clearfix">
    ...
    <section class="espacio col_1 col ">
       ...
       <div class="clearfilx">
			...
			<div class="contacto-data">	
                <span>Email</span>
                    <p><a href="mailto:info@muysimple.org" title="mailto:info@muysimple.org">info@muysimple.org</a></p>
			</div>
      </div>
...
<div class="copyright SacarSeccionCelular" style="height:45px;"><div style="    width: 1010px;;
    margin: 0 auto;"><div style="float:left; margin-top:15px;">Copyright© - Todos los Derechos Reservados.</div><div id="logosfooter2"><a href="mailto:estudio@dot175.com"><img src="logos/dot175_logo.png"></a></div><div id="logosfooter1"><a href="mailto:estudio@dot175.com"><img src="logos/rednet_logo.png"></a></div></div></div>
