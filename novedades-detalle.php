...
<section class="site-DetalleRevista clearfix">
	<div class="row Col_1Mobile" style="position:relative;">
    		<h1 class="TituloNovedadesDetalle SacarWeb">Novedades</h1>
       ...
       ?>
        ...
        <h1 class="SubtituloSuscribite SacarSeccionCelular">Suscribite a nuestras novedades</h1>
        <button type="button" class="SuscribiteNovedades btnNovedadSuscribirse" id="btn_Activa">Suscribite</button>
    		<div class="noticiasMedia DetalleNoticiasMedia">
        		<a href="http://www.facebook.com/sharer.php?u=http://www.muysimple.org/novedades-detalle.php?id=<?php echo($_GET['id']) ?>&t=Muy%20simple" target="_blank" title="Compartir en Facebook" target="_blank" rel="nofollow" class="social-noticia fblink"> 
        		<span class="icon smFbBlanco"></span>
            	</a>
         		<a href="https://twitter.com/intent/tweet?original_referer=http://www.muysimple.org/novedades-detalle.php?id=<?php echo($_GET['id']) ?>&tw_p=tweetbutton&url=http://www.muysimple.org/novedades-detalle.php?id=<?php echo($_GET['id']) ?>&via=fmuysimple" class="social-noticia twlink">
