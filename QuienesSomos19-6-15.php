...
<section class="site-QuienesSomos clearfix" id="ContieneQuienesSomos">
	...
	<div class="MediaQuienesSomos Col_1Mobile">
        ...
        <iframe width="786" height="360" src="https://www.youtube.com/embed/uNaxGxsT6MY?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>        
	...
	<div class="row clearfix">
        ...
        <?php foreach($x->fetch() as $k => $v): ?>
            ...
            <a href="mailto:<?php echo($v["email"]) ?>"> 
                <?php if ($v["img"]!="") { ?>
            	<figure>
                    <div class="content-contacto"><div class="SobreContacto"></div><p id="mailp"><?php echo($v["email"]) ?></p></div> <img src="upload/<?php echo($v["img"]) ?> " width="241" height="195" title="<?php echo($v["nombre"])?>"/>
                </figure> <?php }else{ ?>
                <figure style="background-color:white;">
                    <div class="content-contacto"><div class="SobreContacto"></div><p id="mailp"><?php echo($v["email"]) ?></p></div> <img src="logo_muysimple_gris.png" width="241" height="195" title="<?php echo($v["nombre"])?>"/>
                </figure><?php } ?>
            	<figcaption><?php echo($v["nombre"]); echo($v["apellido"]); ?></figcaption>
...
<section class="EmpresasAsociadas clearfix AlinearMobile"> 
     ...
     <h1>Trabajamos junto a :</h1>
      ...
      <!--   <div class="HoverLogosEmpresas"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image22','','resources/images/FundacionOficios_Color.jpg',1)"><img src="resources/images/FundacionOficios.jpg" width="172" height="97" id="Image22"></a></div>
        ...
        <div class="HoverLogosEmpresas"><img src="resources/images/accenture.jpg" width="183" height="97"/></div> -->
         ...
         <?php require "admin/class/class.empresas.php"; $c=0;?>
        <?php foreach(Empresa::fetch(true) as $k => $v): $c=$c+1; if($c==1){?>
        <div class="HoverLogosEmpresas">
            
            <img src="resources/images/<?php echo($v["img"]) ?>" width="122" height="97" >
        </div> <?php } else{?> <div class="HoverLogosEmpresas">
            
            <img src="resources/images/<?php echo($v["img"]) ?>" width="172" height="97" >
        </div><?php }?>
        <?php endforeach; ?>
    ...
    <ul>
      <li class="SacarSeccionCelular"></li>
      <?php foreach(Empresa::fetchtwo(true) as $k => $v): ?>
