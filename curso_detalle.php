...
<div class="row">
    <h1 class="titulo-capacitarse SacarSeccionCelular" id="aqui-top">Otros Cursos</h1>
<section class="CursosDatos CapacitarceCursosDatos Col_1Mobile" style="margin-bottom:215px;">

    <?php require "functions/capacitacion_menu.inc.php"; traerCapacitacionMenuD(); ?>
...
<section class="site-capacitacion clearfix">
    <div class="row">
    <button class="suscribite enviarConocer otros_cursos " id="curso_top">Otros Cursos</button>
  <div id="aqui"></div>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
  ...
  <script>
    ...
    jQuery(document).ready(function($) {
        var bottom = $('#curso_top').offset().top;
        var top = $('#aqui-top').offset().top;
        $('html,body').delay(500).animate({scrollTop: bottom}, 1300);

        $('#curso_top').click(function(event) {
