...
<section class="slider_principal">
    ...
    <div class="swiper-container ">
      ...
      ?>
        ...
        <!-- <div class="swiper-slide MobileSliderEmprendimiento_1 ">
          <div class="row">
          <img class="slide-img" src="resources/images/slideremprendimiento/image_012.jpg" alt="Emprendimientos">
        		<div class="slider-data PlacaEmprendimineto"><h1>Emprendimientos</h1>
            		<p class="SacarSeccionCelular">Muy Simple ha logrado a corazón y tozudez cumplir<br> dos grandes sueños, te invitamos a conocerlos.</p>
            	</div>
        </div>
        </div> -->
...
<section class="site-emprendimiento clearfix " id="TiendaEmprendimientos">
...
<?php 
require "functions/emprendimientos.inc.php";
getEmprendimiento();
require "functions/galeria_emprendimiento.inc.php"; 
traerGaleriaEmprendimiento();
?>
